...
public class Notification extends JDialog {
    ...
    private void initComponents() {
        ...
        panelNotification = new com.mnm.view.component.notification1.Panel();
        icon = new com.mnm.view.component.RoundedJLabel();
    ...
    private com.mnm.view.component.RoundedJLabel icon;
    private javax.swing.JLabel message;
    private com.mnm.view.component.notification1.Panel panelNotification;
